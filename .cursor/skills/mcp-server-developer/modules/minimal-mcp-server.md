...
**Primary sources**: FastMCP 3.1 docs, Anthropic sample servers, Advanced Memory `server.py`
...
- Use `uv init hello-mcp` or `python -m venv .venv && pip install fastmcp>=3.1.0,<4`.
...
**Confidence**: 🟢 High
**Last validated**: 2025-11-11
**Primary sources**: Anthropic FastMCP quick-start (https://docs.anthropic.com/claude/docs/mcp-quickstart), FastMCP 3.1 API reference, Advanced Memory `.cursorrules`
...
name = "hello-mcp"
version = "0.1.0"
dependencies = ["fastmcp>=3.1.0,<4", "loguru>=0.7.2"]
...
Key FastMCP 3.1 features demonstrated:
