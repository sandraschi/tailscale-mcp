...
Stop-FleetPortSquatters -Ports @($WebPort, $BackendPort) -Label "tailscale-mcp"

if (-not (Assert-FleetPortsAvailable -Ports @($WebPort, $BackendPort) -Label "tailscale-mcp")) { exit 1 }
