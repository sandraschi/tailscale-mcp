    ...
    <div className="space-y-6">
      ...
      >
        <AccordionItem value="credentials">
          <AccordionTrigger>
            Credentials and non-mock testing
          </AccordionTrigger>
          <AccordionContent className="space-y-3 text-sm text-slate-300">
            <p className="text-slate-400">
              Put real values in a <span className="font-mono">.env</span>{" "}
              file at the repository root (copy from{" "}
            ...
            <p className="text-slate-400">
              After restarting the MCP server or webapp backend, tools call
              the live API (not mock data). Credentials are loaded once at
              process start — if a key was rotated after the process
              started, restart it rather than just re-saving{" "}
        ...
        <AccordionItem value="sampling">
          ...
          <AccordionContent className="text-sm text-slate-300">
            <p className="mb-2 text-slate-400">
              ...
              uses FastMCP sampling with tools. Optional environment
              variables:
            </p>
            <ul className="list-inside list-disc space-y-1 font-mono text-xs text-slate-400 sm:text-sm">
              ...
              <li>
                TAILSCALE_SAMPLING_USE_CLIENT_LLM=1 — MCP host performs
                sampling
              </li>
            </ul>
          </AccordionContent>
        ...
        <AccordionItem value="features">
          ...
          <AccordionContent className="space-y-5 text-sm text-slate-300">
            <p className="text-slate-400">
              Four Tailscale features that are easy to mix up. Quick
              reference — full detail in the fleet docs linked below.
            </p>
            <div className="space-y-1">
              ...
              <p className="text-slate-400">
                ...
                <strong className="text-slate-300">public internet</strong>{" "}
                over HTTPS — anyone with the link, no Tailscale required on
                their end. Auto TLS cert, no port forwarding. Use it for:
                sharing a dev server demo with a client, testing a webhook
                receiver, exposing a docs preview. It is <em>not</em> for
                fleet-internal traffic — that already flows over the
                tailnet without Funnel. Tool:{" "}
                <span className="font-mono text-slate-300">
                  manage_funnel
                </span>{" "}
                (operations: funnel_enable, funnel_disable, funnel_status,
                funnel_list, funnel_certificate_info). Requires the{" "}
                <span className="font-mono">funnel</span> node attribute in
                your ACL policy.
              </p>
            </div>
            <div className="space-y-1">
              ...
              <p className="text-slate-400">
                ...
                Funnel). Still alpha: opt your tailnet in via the admin
                console before tools will work. Tool:{" "}
                <span className="font-mono text-slate-300">
                  manage_taildrop
                </span>{" "}
            ...
            <div className="space-y-1">
              ...
              <p className="text-slate-400">
                Named, taggable application endpoints on the tailnet (think
                "the printer" or "the home-lab API" as a stable name, not
                just an IP). Newer addition to the platform — useful once a
                tailnet has enough devices that IP-based ACLs get unwieldy.
                Tool:{" "}
                <span className="font-mono text-slate-300">
            ...
            <div className="space-y-1">
              ...
              <p className="text-slate-400">
                A tailnet-native, customer-deployed relay for when two
                devices can't establish a direct connection (hard NAT,
                restrictive firewalls). Higher throughput than Tailscale's
                managed DERP fallback, and it's just another tailnet node —
                no public IP or port exposure needed. Not yet wrapped as a
                dedicated portmanteau operation in this server; configure
                via the Tailscale CLI/admin console for now.
              </p>
            </div>
            <p className="text-xs text-slate-500 pt-1">
              One-line summary: <strong>Funnel</strong> = share outward to
              the public internet. <strong>Taildrop</strong> = move files
              inward between your own devices. <strong>Services</strong> =
              name your internal endpoints. <strong>Peer Relays</strong> =
              keep connections fast when NAT gets in the way.
            </p>
            <a
        ...
        <AccordionItem value="pages">
          ...
          <AccordionContent className="text-sm text-slate-400">
            <p className="mb-2">
              MCP &amp; API, Runbook, Tool explorer, LLM status, and Local
              chat are in the sidebar.
            </p>
            Use{" "}
