...
4. Start the server:
   ...
   uv run python -m tailscale_mcp.server

   # HTTP mode (for web dashboard)
   uv run uvicorn tailscale_mcp.server:app --port 10821
   ```
5. Open `http://localhost:10821` or the frontend URL.
...
| Something else | [Open a GitHub issue](https://github.com/sandraschi/tailscale-mcp/issues) |
